...
void CompletionQueueRpcEvent::pending(bool pending) { pending_ = pending; }

bool CompletionQueueRpcEvent::ok() const { return ok_; }

bool CompletionQueueRpcEvent::pending() const { return pending_; }
